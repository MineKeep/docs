...
<figure><img src=".gitbook/assets/image.png" alt=""><figcaption><p>A screenshot of the top of the server panel</p></figcaption></figure>

Proceed to click _**Select**_ on the external server plan.

<figure><img src=".gitbook/assets/image (1).png" alt=""><figcaption><p>The external upgrade button</p></figcaption></figure>
